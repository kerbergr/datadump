...
namespace MLCompare
{
    internal class PipeDetails
    {
        ...
        public static string StringToType(string input)
        {
            ...
            if (input.ToLower().Contains("welded sleeve"))
                return "Other";
            if (input.ToLower().Contains("weld-o-let"))
                return "Other";
            if (input.ToLower().Contains("girth weld anomaly"))
                return MetalLoss;
            ...
            if (input.ToLower().Contains("group"))
                return MetalLoss;
            if (input.ToLower().Contains("girth weld"))
                return Weld;
